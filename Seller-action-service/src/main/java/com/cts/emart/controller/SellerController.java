...
import com.cts.emart.service.OrdersService;
import com.cts.emart.service.ProductsService;
...
public class SellerController {
	...
	public ResponseEntity<SubCategory> getBySubCategoryName(@PathVariable(name = "sname") String subCategoryName) {
